...
@section('title', 'Master Tabel Pegawai') @section('content_header')
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mst-pegawai.destroy',$peg->id) }}" method="POST">
                                            <a class="btn btn-sm btn-primary " href="{{ route('mst-pegawai.show',$peg->id) }}"><i class="fa fa-fw fa-eye"></i> Lihat</a>
                                            <a class="btn btn-sm btn-success" href="{{ route('mst-pegawai.edit',$peg->id) }}"><i class="fa fa-fw fa-edit"></i> Ubah</a>
                                            @csrf
                                            @method('DELETE')
